...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :brute_force_protection, :session_timeout, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
   config.twitter.key = "j7zNlIg5Vbt66DBUDyUw"
   config.twitter.secret = "7eObgIB2iL18FBcPHpVQOjgz8TNyZ0klzw1WpftpPA"
   config.twitter.callback_url ="http://friendkarma.herokuapp.com/jobs"
